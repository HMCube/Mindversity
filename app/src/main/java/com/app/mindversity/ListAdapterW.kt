...
class ListAdapterW(private val items: List<ListItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            VIEW_TYPE_IMAGE -> {
                val view = LayoutInflater.from(parent.context).inflate(R.layout.item_image_w, parent, false)
            ...
            is DefaultViewHolder -> {
                ...
                holder.itemView.apply {
                    ...
                    button.setOnClickListener {
                        ...
                        val popupView = inflater.inflate(R.layout.w_popup_layout, null)

                        // Create a PopupWindow with the inflated layout
                        val focusable = true // Allows touches outside the popup to dismiss it
                        val popupWindow = PopupWindow(popupView, 1200, 2500, focusable)
